...
def generate_launch_description():
    ...
    # Checks to see if it is a simulation
    ...
    # Creates a launch configuration based on what was declared above
    use_python = LaunchConfiguration("use_python")
    is_sim = LaunchConfiguration("is_sim")

    # If this is c++, use this node, if not use the other one
    ...
    # If this is python, use this node, if not use the other one
