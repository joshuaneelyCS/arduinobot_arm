...
#include "arduinobot_msgs/action/detail/fibonacci__rosidl_typesupport_fastrtps_c.h"
...
static size_t _Fibonacci_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_msgs__action__Fibonacci_Goal(
...
static size_t _Fibonacci_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_msgs__action__Fibonacci_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_msgs, action, Fibonacci_Result)() {
...
static size_t _Fibonacci_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_msgs__action__Fibonacci_Feedback(
    full_bounded, is_plain, 0);
...
// already included above
// #include "arduinobot_msgs/action/detail/fibonacci__functions.h"  // goal
  ...
  size_t current_alignment)
{
  ...
  // Field name: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_arduinobot_msgs__action__Fibonacci_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static size_t _Fibonacci_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_msgs__action__Fibonacci_SendGoal_Request(
    full_bounded, is_plain, 0);
...
static size_t _Fibonacci_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_msgs__action__Fibonacci_SendGoal_Response(
    full_bounded, is_plain, 0);
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_msgs, action, Fibonacci_SendGoal)() {
...
static size_t _Fibonacci_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_msgs__action__Fibonacci_GetResult_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  // Field name: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_arduinobot_msgs__action__Fibonacci_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static size_t _Fibonacci_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_msgs__action__Fibonacci_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_msgs, action, Fibonacci_GetResult)() {
...
// already included above
// #include "arduinobot_msgs/action/detail/fibonacci__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
  ...
  size_t current_alignment)
{
  ...
  // Field name: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_arduinobot_msgs__action__Fibonacci_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static size_t _Fibonacci_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arduinobot_msgs__action__Fibonacci_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arduinobot_msgs, action, Fibonacci_FeedbackMessage)() {
