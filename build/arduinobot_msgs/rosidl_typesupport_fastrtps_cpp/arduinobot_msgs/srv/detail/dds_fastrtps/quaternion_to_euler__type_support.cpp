...
// functions for arduinobot_msgs::srv::QuaternionToEuler_Request already declared above

// functions for arduinobot_msgs::srv::QuaternionToEuler_Response already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        arduinobot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_QuaternionToEuler_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        arduinobot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_QuaternionToEuler_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arduinobot_msgs::srv::QuaternionToEuler_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        arduinobot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_QuaternionToEuler_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        arduinobot_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_QuaternionToEuler_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const arduinobot_msgs::srv::QuaternionToEuler_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<arduinobot_msgs::srv::QuaternionToEuler_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_arduinobot_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<arduinobot_msgs::srv::QuaternionToEuler_Event>()
{
  return &arduinobot_msgs::srv::typesupport_fastrtps_cpp::_QuaternionToEuler_Event__handle;
}
...
static const rosidl_service_type_support_t _QuaternionToEuler__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<arduinobot_msgs::srv::QuaternionToEuler_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<arduinobot_msgs::srv::QuaternionToEuler_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<arduinobot_msgs::srv::QuaternionToEuler_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<arduinobot_msgs::srv::QuaternionToEuler>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<arduinobot_msgs::srv::QuaternionToEuler>,
